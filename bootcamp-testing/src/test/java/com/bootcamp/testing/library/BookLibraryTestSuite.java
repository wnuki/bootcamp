...
public class BookLibraryTestSuite {
    ...
    public void testListBooksWithConditionReturnList() {
        ...
        Book book2 = new Book("Secretaries and Directors", "Dilbert Michigan", 2013);
        Book book3 = new Book("Secret life of programmers", "Steve Wolkowitz", 2011);
    ...
    public void testListBooksInHandsOfWithFiveBooks() {
        ...
        //When
        int result = bookLibrary.listBookInHandsOf(libraryUser).size();
